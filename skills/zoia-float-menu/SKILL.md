...
A design by [Sheoak](https://github.com/sheoak). It puts an N-way selector on a ZOIA page for **two cells**: a
...
The patches live at [github.com/sheoak](https://github.com/sheoak).
